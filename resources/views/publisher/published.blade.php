...
<div class="content-header-modern">
    <div class="header-left">
        <h2 class="page-title">Published Content</h2>
        <p class="page-subtitle">Historical records of all distributed content.</p>
    </div>
</div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="title-cell">
                            ...
                            <span class="sub-title">Creator: {{ $content->creator->name }}</span>
                        </div>
                    </td>
                    <td>
                    ...
                    <td>
                        <span class="user-name">{{ $content->publisher->name ?? 'System' }}</span>
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="6" class="text-center py-5">
                        <div class="empty-state">
                            <i data-lucide="archive" style="width: 48px; height: 48px; color: var(--text-muted); margin-bottom: 1rem;"></i>
